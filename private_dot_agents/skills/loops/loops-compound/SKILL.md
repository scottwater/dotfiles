...
Format: `[sanitized-symptom]-[sanitized-module]-[YYYYMMDD].md`
...
- `missing-include-brief-system-20251110.md`
- `parameter-not-saving-state-email-processing-20251110.md`
...
Then in the decision menu below, add a note:
```
...
2. Initialize a new skill using your local skill bootstrap workflow for `[skill-name]`
...
4. **Generate filename:** `n-plus-one-brief-generation-brief-system-20251110.md`
5. **Validate YAML:**
   ```yaml
   module: Brief System
   date: 2025-11-10
...
6. **Create documentation:**
   - `docs/solutions/performance-issues/n-plus-one-brief-generation-brief-system-20251110.md`
